        ...
        <footer className="relative overflow-hidden bg-ink text-cream">
            ...
            <div className="relative mx-auto max-w-[1400px] px-5 py-16 md:px-8 md:py-20">
                ...
                <div className="mb-16 flex flex-wrap items-center justify-between gap-8 border-b border-cream/10 pb-14">
                    ...
                    <Link
                        href={`/${locale}/contact`}
                        className="hover:shadow-glow-terra inline-flex h-12 items-center justify-center rounded-full bg-terra px-8 text-sm font-semibold text-cream shadow-sm transition-all hover:-translate-y-0.5 hover:bg-terra-deep"
                    >
                        {str(t('ui.cta.sample'))}
                    </Link>
                </div>
                ...
                <div className="grid gap-12 md:grid-cols-12">
                    <div className="md:col-span-5">
                        ...
                        <div className="mt-4 flex items-center gap-2 text-xs tracking-widest text-terra uppercase">
                            ...
                            <div className="mt-6 flex gap-3">
                                {socials.map((s) => (
                                    <a
                                        ...
                                        rel="noreferrer"
                                        aria-label={s.label}
                                        className="hover:shadow-glow-terra grid size-10 place-items-center rounded-full border border-cream/20 bg-white/5 text-cream/80 transition-all hover:border-terra hover:bg-terra hover:text-cream"
                                    >
                    ...
                    <div className="md:col-span-3">
                        <h4 className="text-xs font-semibold tracking-[0.2em] text-terra uppercase">
                ...
                <div className="mt-14 flex flex-col items-start justify-between gap-3 border-t border-cream/15 pt-6 text-xs text-cream/50 md:flex-row md:items-center">
                    <p>
                        ...
                        {settings.company_name ?? 'Given Coffee'}.{' '}
