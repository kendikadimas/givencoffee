                ...
                <div className="mx-auto max-w-[1400px] px-5 md:px-8">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        {packaging.map((item, i) => {
                            const Icon = packagingIcons[i % packagingIcons.length];

                            return (
                                <Reveal key={item.title} delay={i * 80}>
                                    <div className="flex h-full flex-col rounded-sm border border-border/80 bg-cream p-8 shadow-earth">
                                        <div className="mb-6 flex items-center justify-between">
                                            ...
                                            <span className="rounded-full border border-border/80 bg-bone px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-coffee">
                                                {item.tag}
                                            </span>
                                        </div>
                    ...
                    <div className="grid gap-0 border-t-2 border-ink md:grid-cols-4">
                        {incoterms.map((row, i) => (
                            <Reveal key={row.label} delay={i * 80}>
                                <div className="border-b border-border/60 px-0 py-10 md:border-b-0 md:border-r md:px-12 md:first:pl-0 md:last:border-r-0 md:last:pr-0">
