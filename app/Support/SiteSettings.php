...
class SiteSettings
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'social_tiktok' => 'https://tiktok.com/@givencoffee',
            'social_youtube' => '',
            'instagram_embed' => '<script src="https://elfsightcdn.com/platform.js" async></script>'."\n".'<div class="elfsight-app-2d750e55-b001-4972-b491-4370cd80c0de" data-elfsight-app-lazy></div>',
    ...
    {
        if (self::$data === null) {
            self::$data = array_merge(self::defaults(), Setting::pluck('value', 'key')->toArray());
        }
